...
/// الخدمة المسؤولة عن كل ما يتعلق بالجلسات: التقديم، الحساب،
/// جلب التراكمي، وحفظ البيانات.
class SessionService {
  ...
  SessionService({
    ...
    required QuranDatabaseService quranDb,
  })  : _client = supabaseClient,
        _quranDb = quranDb;

  /// استقبال تقرير الجلسة وحساب كامل التفاصيل ثم حفظها
  Future<SessionResult> submitFullSession(SessionSubmission submission) async {
    ...
    // 2. تحويل أجزاء التسميع إلى مدخلات للآلة الحاسبة
  ...
  /// جلب مجموع صفحات الجديد من آخر يومين فريدين
  ...
  /// جلب ملف الطالب، مع قيم افتراضية آمنة
